...
Statistical Significance (p = 0.033) obtained in the Kaplan-Meier plot is below the standard 0.05 threshold, meaning it is very unlikely that the difference between the two groups happened by chance.<br>
